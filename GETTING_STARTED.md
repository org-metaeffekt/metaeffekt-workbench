...
must be available in the root of this repository or in the encompassing integration harness. A template for this file has been provided here: [.local.properties.template](.local.properties.template).
...
pipeline scripts should be necessary if the .local.properties file has been set correctly.
...
be downloaded when given the correct url in your .local.properties file.
...
the necessary parameter in your .local.properties file and the following files:
