...
set_global_variables() {
  ...
  readonly WORKSPACE_DIR="$WORKBENCH_DIR/tests/resources/workspace-005/traxon"
  ...
  logger_init "$LOG_DIR/traxon-pipeline_en.log"
...
main() {
  ...
  attachAssetMetadata \
    $WORKSPACE_DIR/traxon-scan-result-inventory.xlsx \
    traxon \
    "Traxon" \
    "unspecific" \
    "" \
  ...
  enrichInventory \
    $WORKSPACE_DIR/traxon-scan-result-inventory.xlsx \
    $WORKSPACE_DIR/traxon-scan-result-advised-inventory.xlsx \
    $WORKSPACE_DIR/tmp \
    demo \
    default \
    "Traxon" "unspecific" "Demo"

  createVulnerabilityAssessmentDashboard \
    $WORKSPACE_DIR/traxon-scan-result-advised-inventory.xlsx \
    $WORKSPACE_DIR/traxon-scan-result-advised-inventory.html \
    demo \
    default
