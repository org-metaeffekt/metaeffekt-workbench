...
enrich_inventory() {
  ...
  ASSESSMENT_DIR="$WORKBENCH_DIR/assessments/metaeffekt/cisco-catalyst-sd-wan-manager-20/local/assessments/generic"
  CONTEXT_DIR="$WORKBENCH_DIR/assessments/metaeffekt/cisco-catalyst-sd-wan-manager-20/local/context"
