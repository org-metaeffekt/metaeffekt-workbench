...
set_global_variables() {
  ...
  logger_init "$LOG_DIR/cisco-catalyst-sd-wan-manager-pipeline_en.log"
  create_workspace_variables "$WORKSPACE_DIR/cisco-catalyst-sd-wan-manager-20.12.5.2" "cisco-catalyst-sd-wan-manager-20.12.5.2"
  ...
  ASSET_ID="cisco-catalyst-sd-wan-manager-20"
